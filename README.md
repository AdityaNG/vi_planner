...
- 🎯 Entry points to execute your program using `python -m <vi_planner>` or `$ vi_planner` with basic CLI argument parsing.
...
Awesome vi_planner created by AdityaNG
...
```py
from vi_planner import BaseClass
from vi_planner import base_function
